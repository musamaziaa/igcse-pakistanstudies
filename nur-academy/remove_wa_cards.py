...
# The old WhatsApp settings card block that was injected in multiple places
old_wa_card = """              {/* WhatsApp Reports Settings */}
...
count = content.count(old_wa_card)
print(f"Found {count} instances of old WA card")
content = content.replace(old_wa_card, "")

with open("/home/muz/Documents/igcse-pakistanstudies/nur-academy/src/App.tsx", "w") as f:
    f.write(content)
print("Done removing old WA cards")
